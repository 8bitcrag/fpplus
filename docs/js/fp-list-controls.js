import{LitElement as c,css as u,html as r,nothing as l}from"lit";import p from"../css/system.css"with{type:"css"};import{activeFilters as d,clearFilters as f,refine as o}from"./search/contract.js";import{AWARD_LABEL as m,displayName as b,segmentLabel as y}from"./format.js";const a={methods:"Method",endings:"Ending",rounds:"Round",segments:"Card",outcomes:"Outcome",awards:"Accolade",years:"Year",titleOnly:"Title fights"};class g extends c{static properties={label:{type:String},query:{attribute:!1},revealed:{type:Boolean},chips:{type:Boolean},filters:{type:Number},sortable:{type:Boolean},sharedOnly:{type:Boolean},showSharedOnly:{type:Boolean}};static styles=[p,u`
